...
class RatingController extends Controller
{
    public function download($videoId)
    {
        ...
        $columns = ['Visual Quality Experience', 'Streaming Quality', 'User Interface (UI) and Navigation', 'Overall Rating', 'User Opinion'];
        ...
        $callback = function() use ($ratings, $columns) {
            ...
            foreach ($ratings as $rating) {
                ...
                fputcsv($file, array($row['Visual Quality Experience'], $row['Streaming Quality'], $row['User Interface (UI) and Navigation'], $row['Overall Rating'], $row['User Opinion']));
            }
