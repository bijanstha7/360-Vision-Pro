            ...
            <div class="row">
                <div class="form-group col-sm-6 col-md-6 col-xl-6 col-lg-6 mb-2">
                    ...
                    <div class="input-group">
                        <input required type="text" class="form-control" name="title" value="{{ $video->title }}" placeholder="Enter Title of video">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6 col-md-6 col-xl-6 col-lg-6 mb-2">
                    <img src="/{{ htmlentities($video->thumbnail) }}" alt="" height="150" >
                </div>
                <!-- <div class="form-group col-sm-6 col-md-6 col-xl-6 col-lg-6 mb-2">
                    ...
                    <div class="input-group">
                        <select class="form-control" required name="video_type" id="" placeholder="Select Video Type">
                            ...
                            <option value="Original" {{ $video->video_type ==  "Original" ? "selected" : '' }}>Original</option>
                            <option value="Enhanced" {{ $video->video_type ==  "Enhanced" ? "selected" : '' }}>Enhanced</option>
                        </select>
                    </div>
                </div> -->
                ...
                <div class="form-group col-sm-12 col-md-12 col-xl-12 col-lg-6 mb-2">
                ...
                <div class="form-group col-sm-6 col-md-6 col-xl-6 col-lg-6 mb-2">
                    ...
                    <div class="input-group">
                        <input type="file" class="form-control" name="enhanced_video" accept="video/*">
                    </div>
                </div>
                @if ($video->video_type == 'Enhanced')
                <div class="form-group col-sm-12 col-md-12 col-xl-12 col-lg-6 mb-2">
                    <div class="col-12 py-2">
                        <video id="player_orig" class="player video-js vjs-default-skin vjs-big-play-centered" crossorigin="anonymous" preload="metadata" autoplay controls>
                ...
                <div class="form-group col-sm-6 col-md-6 col-lg-6 col-xl-2 ml-5">
                    <label for="switch4" data-on-label="Yes" data-off-label="No">
                        ...
                        <div class="form-check form-switch form-switch-lg " dir="ltr">
                            ...
                            <input {{ $video->trending == '1' ? 'checked' : '' }} class="form-check-input" name="trending" type="checkbox" id="SwitchCheckSizelg">
                        </div>
                    </label>
                </div>
                ...
                <div class="form-group col-sm-6 col-md-6 col-lg-6 col-xl-2 ml-5">
                    <label for="switch4" data-on-label="Yes" data-off-label="No">
                        ...
                        <div class="form-check form-switch form-switch-lg " dir="ltr">
                            ...
                            <input {{ $video->status == '1' ? 'checked' : '' }} class="form-check-input" name="status" type="checkbox" id="SwitchCheckSizelg">
                        </div>
                    </label>
                </div>
